...
type AnalysesLoadResult =
  | { kind: "ready"; analyses: AnalysisRow[] }
  | { kind: "error" };

function AnalysesLoadError() {
  return (
...
function AnalysesList({ analyses }: { analyses: AnalysisRow[] }) {
...
export default async function AnalysesPage() {
  ...
  try {
    result = { kind: "ready", analyses: await getAnalyses() };
  } catch (error: unknown) {
