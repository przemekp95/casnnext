...
export class FixAnalysesData1768119419753 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const titleUpdates = [
            ...
            { slug: 'kochman-artykul', title: 'Rozw�j otoczenia instytucjonalnego polityki mBodzie|owej' },
            ...
            { slug: 'domanska-artykul', title: 'Raport dotyczcy badania to|samo[ci wsp�lnotowej' },
            ...
            { slug: 'bruszewski-artykul', title: 'Rozw�j SiB Zbrojnych RP' },
