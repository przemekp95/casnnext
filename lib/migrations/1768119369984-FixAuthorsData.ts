    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            SET \`bio\` = CASE
                ...
                WHEN \`slug\` = 'domanska' THEN 'Prezes Instytutu Staszica; adiunkt Instytutu Studi�w Midzynarodowych SzkoBy GB�wnej Handlowej w Warszawie; doktor habilitowany nauk ekonomicznych.'
                WHEN \`slug\` = 'lewandowski' THEN 'Adwokat; doktor nauk prawnych; Dyrektor Centrum Interwencji Procesowej Ordo Iuris.'
                WHEN \`slug\` = 'kochan' THEN 'Jzykoznawca; medioznawca. Naukowo zajmuje si jzykiem komunikacji publicznej; wizerunkiem os�b i instytucji.'
