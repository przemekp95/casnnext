...
// Export AppDataSource - don't create in CI to avoid E2E test issues
export const AppDataSource = process.env.GITHUB_ACTIONS ? null : (process.env.NEXT_PHASE?.includes('build') ? null : getDataSource());
